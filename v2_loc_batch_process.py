"""
Implementation of the proposed Missouri Medicare Levl of Care (LOC) algorithm, v2.
For use on csv files with each survey question as a labeled column in the file.

Algorithm is here: 
https://health.mo.gov/seniors/hcbs/pmvmdocs/PM-VM-19-08-loc-draft-2.0.pdf

Written April 15, 2019 by Emma Weil at Upturn / emma@upturn.org
...
def LOC_cognition(client):
	...
	if (c1 == 3 and (d1 == 4 or d2 == 4) or c1 == 4):
		new_loc_cognition = 9
...
def LOC_mobility(client):
	...
	if ((g2e == 0 or g2e == 1 or g2e == 2 or g2e == 8) and 
		(g2f == 0 or g2f == 1 or g2f == 2 or g2f == 8) and 
		(g2i == 0 or g2i == 1 or g2i == 2 or g2i == 8)):
		new_loc_mobility = 0
...
def LOC_toileting(client):
	...
	if ((g2g == 0 or g2g == 1 or g2g == 2 or g2g == 8) and 
		(g2h == 0 or g2h == 1 or g2h == 2 or g2h == 8)):
		new_loc_toileting = 0
...
def LOC_bathing(client):
	...
	if (g2a == 0 or g2a == 1 or g2a == 2 or g2a == 8):
		new_loc_bathing = 0
...
def LOC_dressing(client):
	...
	if ((g2b == 0 or g2b == 1 or g2b == 2 or g2b == 8) and
		(g2c == 0 or g2c == 1 or g2c == 2 or g2c == 8) and
		(g2d == 0 or g2d == 1 or g2d == 2 or g2d == 8)):
		new_loc_dressing = 0

	if ((g2b == 3 or g2b == 4) or
		(g2c == 3 or g2c == 4) or
		(g2d == 3 or g2d == 4)):
		new_loc_dressing = 3

	if ((g2b == 5 or g2b == 6) or
		(g2c == 5 or g2c == 6) or
		(g2d == 5 or g2d == 6)):
		new_loc_dressing = 6
...
def LOC_rehabilitation(client):
	...
	if (n3ea == 1 or n3fa == 1 or n3ga == 1 or n3ia == 1):
...
def LOC_treatments(client):
	...
	if ((h1 == 1) or
		(h3 == 1) or 
		(k3 == 5 or k3 == 6 or k3 == 7 or k3 == 8) or
		(n2g == 1 or n2g == 2 or n2g == 3 or n2g == 4) or 
		(n2h == 1 or n2h == 2 or n2h == 3 or n2h == 4) or
		((n2k == 1 or n2k == 2 or n2k == 3 or n2k == 4) and 
			(l1 == 2 or l1 == 3 or l1 == 4 or l1 == 5 or l1 == 6))):
