...
function LOCMobility() {
	...
	// rules
	if ((g2e == 0 || g2e == 1 || g2e == 2 || g2e == 8) && 
		(g2f == 0 || g2f == 1 || g2f == 2 || g2f == 8) && 
		(g2i == 0 || g2i == 1 || g2i == 2 || g2i == 8)) {
		new_loc_mobility = 0;
	}
	...
	// display new LOC for subcategory && update total
...
function LOCToileting() {
	...
	// rules
	if ((g2g == 0 || g2g == 1 || g2g == 2 || g2g == 8) && 
		(g2h == 0 || g2h == 1 || g2h == 2 || g2h == 8)) {
		new_loc_toileting = 0;
	}
...
function LOCDressing() {
	...
	// rules
	if ((g2b == 0 || g2b == 1 || g2b == 2 || g2b == 8) &&
		(g2c == 0 || g2c == 1 || g2c == 2 || g2c == 8) &&
		(g2d == 0 || g2d == 1 || g2d == 2 || g2d == 8)) {
		new_loc_dressing = 0;
	}
...
function LOCTreatments() {
	...
	// rules
	if ((h1 == 0 || h1 == 2 || h1 == 3 || h1 == 4 || h1 == 5 || h1 == 8) &&
		(h3 == 0 || h3 == 2 || h3 == 3 || h3 == 4 || h3 == 5 || h3 == 8) &&
		(l1 == 0 || l1 == 1) &&
